...
class GlobalDecisionIndex extends StatefulWidget {
  @override
  State<GlobalDecisionIndex> createState() => _GlobalDecisionIndexState();
}

class _GlobalDecisionIndexState extends State<GlobalDecisionIndex> {
  @override
          ...
          children: [
            Expanded(
              ...
              child: ListView.builder(
                itemCount: global_Decisions.length,
                    ...
                    Column(
                      children: [
                        new makeItem_Decisions(
                            image: global_Decisions[index].image,
                            number: global_Decisions[index].number,
                            title: global_Decisions[index].title,
                            date: global_Decisions[index].date,
                            goToDetailPage: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          DecisionimagePreview(
                                            title:
                                                global_Decisions[index].title,
                                            image:
                                                global_Decisions[index].image,
                                          )));
                            }),
                        SizedBox(
                          height: 20,
...
class MysearchDelegate extends SearchDelegate {
  List searchResults = global_Decisions;
