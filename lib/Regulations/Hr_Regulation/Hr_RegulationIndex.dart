...
class hrRegulationIndex extends StatefulWidget {
  @override
  State<hrRegulationIndex> createState() => _hrRegulationIndexState();
}

class _hrRegulationIndexState extends State<hrRegulationIndex> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Container(
          ...
          child: Text(
            hr_Regulation_detail[0]["name"].toString(),
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "رقم ${hr_Regulation_detail[0]["no"]} الصادره بتاريخ ${hr_Regulation_detail[0]["date"]}",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.bold,
            ...
            Expanded(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (hr_regulation_content[index].image == null) {
                    return FadeAnimation(
                      .15,
                      Column(
                        children: [
                          new makeItem_Laws_Regulations(
                              numberItem: hr_regulation_content[index].number,
                              section: hr_regulation_content[index].section,
                              title: hr_regulation_content[index].title,
                              goToDetailPage: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (BuildContext context) =>
                                            ItemPreview(
                                              bookTitle: hr_Regulation_detail[0]
                                                  ["name"],
                                              detail:
                                                  hr_regulation_content[index]
                                                      .detail,
                                              section:
                                                  hr_regulation_content[index]
                                                      .section,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (BuildContext context) => ItemPreview(
                                    bookTitle: hr_Regulation_detail[0]["name"],
                                    detail: hr_regulation_content[index].detail,
                                    section:
                                        hr_regulation_content[index].section,
                                    title: hr_regulation_content[index].title,
                                    number: hr_regulation_content[index].number,
                                  )));
                    }),
                SizedBox(
                  height: 20,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (BuildContext context) => imagePreview(
                                    subjectTitle: hr_Regulation_detail[0]
                                        ["name"],
                                    section:
                                        hr_regulation_content[index].section,
                                    title: hr_regulation_content[index].title,
                                    image: hr_regulation_content[index].image,
                                    number: hr_regulation_content[index].number,
                                    detail: hr_regulation_content[index].detail,
                                  )));
                    }),
...
class MysearchDelegate extends SearchDelegate {
  List<Hr_Regulation> searchResults = hr_regulation_content;
  ...
  Widget buildSuggestions(BuildContext context) {
    List<Hr_Regulation> suggestions = searchResults.where((searchResult) {
                ...
                onTap: () {
                  ...
                  if (suggestion.image != null) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (BuildContext context) => imagePreview(
                              subjectTitle: hr_Regulation_detail[0]["name"],
